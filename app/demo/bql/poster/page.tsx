...
import { PrintButton } from '@/app/bql/poster/print-button'

export const dynamic = 'force-dynamic'

export default async function DemoPoster() {
  // Bản demo dùng tên miền giả: in poster từ màn demo mà ra mã QR trỏ về
  // localhost thì có người dán nhầm lên sảnh thật.
  const url = 'https://vbuilding.example.vn/'
